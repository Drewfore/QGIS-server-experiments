...
In this repo are two html pages that consume a QGIS Server webservice showing some example applications using QGIS Server. The corresponding QGIS project and data is also provided so that users can install QGIS Server and drop in this project and sample pages.
...
- LG_Meetup: Folder containing QGIS project and data.
